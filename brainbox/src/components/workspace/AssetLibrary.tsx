    ...
    <div className="w-80 h-full glass-panel border-r border-white/10 flex flex-col z-10 shrink-0">
      ...
      {mode === 'library' ? (
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Intelligent Arrangement: Chats Top, Prompts Bottom */}
              ...
              <div className="flex-1 overflow-y-auto space-y-2 pr-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                {chats.map((chat) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-white/40 line-clamp-1">{chat.description}</p>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-2 pr-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                {prompts.map((prompt) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-white/40 line-clamp-1">{prompt.description}</p>
                  </div>
                ))}
              </div>
            </div>
