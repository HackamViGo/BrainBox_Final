...
## 2026-04-13 — Incorrect environment variable assignment in package.json

**Контекст:** При преминаване към централизиран .env файл чрез dotenv-cli, добавихме NODE_OPTIONS за Next.js dev сървъра.
**Грешка:** Използвахме 'dotenv -e ... -- NODE_OPTIONS=...', което кара dotenv да търси binary с име 'NODE_OPTIONS=...'.
**Решение:** NODE_OPTIONS трябва да е ПРЕДИ dotenv командата: 'NODE_OPTIONS=... dotenv -e ... -- next dev'.
**Правило напред:** Винаги проверявай дали командата след '--' в dotenv-cli е валиден изпълним файл. При нужда от env vars, слагай ги в началото на целия ред.
